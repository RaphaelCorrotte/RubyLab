  ...
  module Commands
    def help
      RubyLab::Command.new({
        ...
        if RubyLab::Utils.get_command((tools[:args][0]).to_s, { :boolean => true })
          command = RubyLab::Utils.get_command(tools[:args][0])
          ...
          event.channel.send_embed do |embed|
            RubyLab::Utils.build_embed(embed, event.message)
            RubyLab::Utils.add_fields(embed, fields, true)
          end
        elsif tools[:args][0] && !RubyLab::Utils.get_command(tools[:args][0], { :boolean => true })
          ...
          event.channel.send_embed do |embed|
            RubyLab::Utils.build_embed(embed, event.message)
            RubyLab::Utils.add_fields(embed, fields, false)
